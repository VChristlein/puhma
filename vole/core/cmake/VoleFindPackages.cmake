...
vole_check_package(TBB
		"TBB"
		"Please install TBB to use it"
		TBB_FOUND
		"${TBB_INCLUDE_DIRS}"
		"${TBB_LIBRARIES}"
)
option(USE_TBB "Use Intel Threading Building Blocks" ON)
if(TBB_FOUND)
...
# fftw3
find_package(Fftw)
vole_check_package(FFTW
		"Fftw"
	    "Please install fftw3-library"
		FFTW_FOUND
		"${FFTW_INCLUDE_DIR}"
		"${FFTW_LIBRARY}"
)
...
find_package(LAPACK)
vole_check_package(LAPACK
		"Lapack"
		"Please install Lapack-library"
		LAPACK_FOUND
		""
		"${LAPACK_LIBRARIES}"
)
