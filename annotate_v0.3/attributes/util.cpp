...
void DataPrepare :: prepare()
{
    ...
    if(filePathManager->fileExist("classes")&&filePathManager->fileExist("data")){
        ...
        if(config.dataset == "IAM"){
            ...
            writeoutData();
            writeoutClasses();
        }else if(config.dataset == "PUHMA"){
            if(config.inputfolder == ""){
                throw std::runtime_error("Util_DataPrepare:: prepare : input folder do not provide.");
            }
    ...
    : config(c)
{
    ...
    classesPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(classesPath)).filePath()).toStdString();
    
    //dataPath
    dataPath = "data_"+ndata+(config.digitalInPHOC?"_digital":"")+".txt";
    dataPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(dataPath)).filePath()).toStdString();

    //pcaPath
    pcaPath = "pca_"+ndata+".yaml";
    pcaPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(pcaPath)).filePath()).toStdString();

    //gmmPath
    gmmPath = "gmm_"+ndata+".yaml";
    gmmPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(gmmPath)).filePath()).toStdString();

    //trainSetPath
    trainSetPath = "train_"+ndata+".txt";
    trainSetPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(trainSetPath)).filePath()).toStdString();

    //testSetPath
    testSetPath = "test_"+ndata+".txt";
    testSetPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(testSetPath)).filePath()).toStdString();

    //validationSetPath
    validationSetPath = "vali_"+ndata+".txt";
    validationSetPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
            , QString::fromStdString(validationSetPath)).filePath()).toStdString();

    //onlineSetPath
    onlineSetPath = "online_"+ndata+".txt";
    onlineSetPath = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresTrain = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresValidation = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresTest = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresTrainOnline = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresValidationOnline = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attRepresTestOnline = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attriModels = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
    ...
    attriModelsOnline = (QFileInfo(QDir(QString::fromStdString(config.outputdir))
