...
//            qDebug() << "file property" << property_node.tagName();
			current_file->set( property_node.tagName().toStdString(), property_node.text().toStdString() );
		}
...
QDomElement IA::ImgAnnotations :: addElement( QDomDocument & doc, QDomNode & node,
                                      const QString & tag,
                                      const QString & value )
{
...
void IA::ImgAnnotations :: addAnnotationXML( QDomDocument & dom_doc, const QStringList & properties )
{
...
void IA::ImgAnnotations :: saveToFile( QFile & file , const QStringList & properties )
{		 	
...
void IA::ImgAnnotations::removeProperty(const IDList & objIDList, std::string property)
{
...
//    qDebug() << filePath.c_str() << dirpath.c_str();
    return dirpath;
}
